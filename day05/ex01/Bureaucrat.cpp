...
void Bureaucrat::signForm(Form &form)
{
	...
	{
		std::cout << this->_name << " cannot sign " << form.getName() << " because the grade is out of range" << std::endl; 
	}
...
const char *Bureaucrat::GradeTooHighException::what() const  throw() {return "Grade to high";}
...
{
	coutN << Trump.getName() << " Grade is: " << Trump.getGrade();
}